// import React, { useState } from "react";  (ERROR)
import React from "react";
import "./App.css";

// const [quarterCount, setQuarterCount] = useState(0); (ERROR)
  ...
  return (
    <div className="bottomRow">
      ...
      <div className="quarter">
        ...
        {/* <div className="quarter__value">{quarterCount - setQuarterCount}</div> */}
      </div>
    </div>
  );
};
